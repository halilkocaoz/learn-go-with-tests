...
Often developers have to use reflection to implement these _ahem_ generic functions, which is usually painful and can hurt the performance of your program.
